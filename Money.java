...
public class Money {
    ...
    // constructor which takes both a dollar and cent value but checks to make sure values are positive
    ...
    // adds values from another money object but checks to make sure values are positive
    ...
    // Helper method that returned a string version of the value but without the dollar sign
    // This was set up so I would be able to do a parseDouble() on this string for the getMoney() method
    ...
    // Helper method that checks to see if the cent value is over 99 and if it is then I add a dollar and subtract 100
